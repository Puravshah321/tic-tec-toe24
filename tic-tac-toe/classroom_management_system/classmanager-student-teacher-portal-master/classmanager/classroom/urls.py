...
urlpatterns =[
    ...
    path('classroom/signup/student_signup/',views.StudentSignUp,name="StudentSignUp"),
    path('classroom/signup/teacher_signup/',views.TeacherSignUp,name="TeacherSignUp"),
    path('login/',views.user_login,name="login"),
    path('logout/',views.user_logout,name="logout"),
    path('classroom/student/<int:pk>/',views.StudentDetailView.as_view(),name="student_detail"),
    path('classroom/teacher/<int:pk>/',views.TeacherDetailView.as_view(),name="teacher_detail"),
